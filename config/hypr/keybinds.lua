...
hl.bind(mainMod .. " + CTRL + ALT + P", hl.dsp.exec_cmd("poweroff"))
hl.bind(mainMod .. " + CTRL + ALT + R", hl.dsp.exec_cmd("reboot"))

-- Screenshots
hl.bind("print",                   hl.dsp.exec_cmd("hyprshot -m output -m eDP-1 -o $HOME/Pictures/screenshots"))
hl.bind(mainMod .. " + ALT + S",   hl.dsp.exec_cmd("hyprshot -o $HOME/Pictures/screenshots -m region"))

-- Wallpaper
hl.bind(mainMod .. " + W",         hl.dsp.exec_cmd("$HOME/.local/bin/ranwall.sh"))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("$HOME/.local/bin/ranwall.sh -s anime -r"))
